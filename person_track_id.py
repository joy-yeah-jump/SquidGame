class PersonTrackId :
    id = -1
    alive = True
    ix1, iy1, ix2, iy2 = -1, -1, -1, -1      # first coordinate
    lx1, ly1, lx2, ly2 = -1, -1, -1, -1      # last coordinate
    inx1, iny1, inx2, iny2 = -1, -1, -1, -1  # intersection point
    now = -1                                 # now(last) area
    inter = -1                               # intersection area
    ft = -1                                  # first detected time
    lt = -1                                  # last detected time
